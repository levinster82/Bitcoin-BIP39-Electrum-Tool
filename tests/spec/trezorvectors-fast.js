...
async function switchToTab(tabSelector) {
    ...
    await tab.click();
    await driver.sleep(30); // Ultra-fast tab switching
}
...
async function setAccountAndChange(accountField, changeField, changeValue) {
    ...
    await driver.sleep(30); // Ultra-fast field updates
}
...
async function getAllAddressesForTab(tabSelector, accountField, changeField) {
    ...
    await driver.sleep(100); // Faster address generation
    ...
    await driver.sleep(100); // Faster address regeneration
